...
var (
	...
	//incomingBufferSize = flag.Uint64("ib", 1024, "incoming TCP buffer filter size")
	//outboundBufferSize = flag.Uint64("ob", 1024, "outbound TCP buffer filter size")
...
func main() {
	...
	for {
		...
		//p.SetMaxFilterInBuff(*incomingBufferSize)
		//p.SetMaxFilterOutBuff(*outboundBufferSize)
